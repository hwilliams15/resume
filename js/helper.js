...
var HTMLskillsStart = '<div id="skills-div"><h3 id="skills-h3">Skills at a Glance:</h3><ul id="skills" class="flex-box"></ul></div>';
...
var HTMLonlineURL = '<br><a class="dark-orange-text" href="#">%data%</a>';
